...
ActiveRecord::Schema.define(version: 2021_02_20_015014) do
  ...
  create_table "stocks", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["code", "supplier_id", "category_id"], name: "index_stocks_on_code_and_supplier_id_and_category_id", unique: true
